...
//#region src/components/Bear.tsx
			...
			children: [
				...
				/* @__PURE__ */ jsxs("g", {
					...
					children: [
						...
						expression === "roar" ? /* @__PURE__ */ jsxs("g", {
						...
						}) : expression === "sleepy" ? /* @__PURE__ */ jsx("ellipse", {
							cx: "66",
							cy: "72",
							rx: "6",
							ry: "7",
							fill: "var(--bear-nose)",
							opacity: "0.85"
						}) : expression === "silly" ? /* @__PURE__ */ jsx("path", {
							d: "M56 71 q10 9 20 0",
				...
				(expression === "furious" || expression === "roar") && /* @__PURE__ */ jsxs("g", {
...
function UselessProject() {
	...
	const [peek, setPeek] = useState("none");
	...
	const [expr, setExpr] = useState("angry");
	...
	const updateStatistics = useCallback((key) => {
		setStats((s) => ({
			...s,
			[key]: s[key] + 1
		}));
	...
	return /* @__PURE__ */ jsxs("main", {
		...
		children: [
			/* @__PURE__ */ jsx("div", { className: "wall" }),
			/* @__PURE__ */ jsx("div", { className: "baseboard" }),
			/* @__PURE__ */ jsx("div", { className: "floor" }),
			/* @__PURE__ */ jsxs("div", {
				className: "doorframe",
				children: [
					/* @__PURE__ */ jsx("div", { className: "doorway-dark" }),
					/* @__PURE__ */ jsxs("div", {
						className: "doorway-slot",
						children: [eyes && /* @__PURE__ */ jsxs("div", {
							className: "doorway-eyes",
							children: [/* @__PURE__ */ jsx("span", {}), /* @__PURE__ */ jsx("span", {})]
						}), peek !== "none" && /* @__PURE__ */ jsx("div", {
							className: `peek ${peek === "out" ? "peek--out" : ""}`,
							children: /* @__PURE__ */ jsx(Bear, {
					...
					/* @__PURE__ */ jsx("div", { className: `door door--${doorState}` })
				]
			}),
			bearVisible && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				className: "lamp",
				children: [
					/* @__PURE__ */ jsx("div", { className: "lamp-wire" }),
					/* @__PURE__ */ jsx("div", { className: "lamp-shade" }),
					/* @__PURE__ */ jsx("div", { className: `bulb ${lightOn ? "bulb--on" : ""}` })
				]
			}),
			/* @__PURE__ */ jsxs("div", {
				...
				}), /* @__PURE__ */ jsx("div", { className: "rope-knob" })]
			}),
			/* @__PURE__ */ jsx("div", {
				className: "lightcone",
			...
			taunt && /* @__PURE__ */ jsx("div", {
				className: "hud hud--taunt",
				children: taunt
			}),
			!everPulled && /* @__PURE__ */ jsx("div", {
				className: "hint",
